...
export default function LandingFooter() {
  return (
    <footer
      className="relative bg-beige border-accent border-accent-top overflow-hidden"
      style={{ fontFamily: '"Mier A", sans-serif', fontSize: '16px' }}
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-5">
              ...
              <p
                ...
                style={{ fontSize: '16px' }}
              >
                Empathetic AI conversations for mental wellness. Private,
                available 24/7, and designed to support your journey toward
                inner peace.
              </p>
              ...
              <p className="text-gray-600 mb-6" style={{ fontSize: '16px' }}>
                ...
                <Link
                  href="/contact-us"
                  className="text-gray-800 hover:text-gray-900 font-medium underline underline-offset-2"
                >
                  contact support
                </Link>
                .
