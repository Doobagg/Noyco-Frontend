...
const FeaturesSection = () => {
  const features = [
    {
      ...
      description:
        'Experience truly understanding conversations with AI that recognizes emotions, context, and provides compassionate responses tailored to your mental well-being.',
    ...
    },
    {
      ...
      description:
        'Get immediate emotional support and personalized guidance whenever you need it, with intelligent responses that understand your current state.',
    ...
    },
    {
      ...
      description:
        'Access a team of specialized AI agents trained in anxiety management, depression support, loneliness counseling, and therapeutic techniques.',
    ...
    },
    {
      ...
      description:
        'Build lasting positive habits with an AI companion that motivates, tracks your progress, and celebrates your achievements.',
    ...
    },
    {
      ...
      description:
        'Watch as your AI companion evolves with you, learning your preferences and adapting its approach to provide increasingly personalized support.',
    ...
    },
    {
      ...
      description:
        'Your deepest thoughts remain completely confidential with military-grade encryption and healthcare compliance standards.',
  ...
  return (
    <section
      className="relative py-16 bg-beige"
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl  text-gray-900 mb-6 leading-tight">
            Your companion for{' '}
            <span className="bg-clip-text text-[#5d83b8]">inner peace</span>
          </h2>

          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experience emotional support through advanced AI that understands,
            adapts, and grows with your mental health journey
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative bg-beige p-6 border-accent border-accent-top border-accent-left border-accent-right hover:border-gray-300 transition-all duration-700 group-hover:shadow-xl group-hover:-translate-y-1 h-full flex flex-col">
                ...
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-[0.02] transition-all duration-500`}
                ></div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center mb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-8">
              Every interaction is crafted to feel natural, supportive, and
              genuinely helpful for your mental health journey
            </p>
              ...
              {[
                {
                  ...
                  description:
                    'Built on cutting-edge research in cognitive behavioral therapy and positive psychology',
                },
                {
                  icon: <HeartIcon className="w-5 h-5" />,
                  title: 'Emotional Intelligence',
                  description:
                    'Recognizes and responds appropriately to your emotional state and communication style',
                },
                {
                  icon: <SparklesIcon className="w-5 h-5" />,
                  title: 'Personalized Experience',
                  description:
                    'Adapts and evolves based on your unique needs, preferences, and progress over time',
                },
              ].map((highlight, index) => (
